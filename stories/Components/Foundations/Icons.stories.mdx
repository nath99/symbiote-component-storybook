...
import { Icon } from '@symbiotetech/symbiote-component-library';

<Meta title="Components/Foundations/Icons" component={Icon} />
...
<Icon icon="biking" size="xl" />
<Icon icon="biking" size="lg" />
<Icon icon="biking" />
<Icon icon="biking" size="sm" />
<Icon icon="biking" size="xs" />
<Icon icon="biking" size="xxs" />
...
<Icon icon="wind" size="xl" />
<Icon icon="fire" size="xl" />

<div className="icon-inverted-background" style={{backgroundColor: "#444444", display: "inline-block", padding: "1rem"}}>
    <Icon icon="globe" color="inverted" size="xl" />
    <Icon icon="wind" color="inverted" size="xl" />
    <Icon icon="fire" color="inverted" size="xl" />
</div>
